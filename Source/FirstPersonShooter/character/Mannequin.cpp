...
void AMannequin::BeginPlay()
{
	...
	{
		InputComponent->BindAction("Fire", IE_Pressed, this, &AMannequin::Pullthetrigger);
	}
...
void AMannequin::SetupPlayerInputComponent(UInputComponent* InputComponent)
{
...
void AMannequin::Pullthetrigger()
{
	Gun->OnFire();
}
