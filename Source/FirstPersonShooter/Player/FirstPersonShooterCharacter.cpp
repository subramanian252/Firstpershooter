...
void AFirstPersonShooterCharacter::BeginPlay()
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Gun blueprint Mising"));
		return;
	}
...
void AFirstPersonShooterCharacter::SetupPlayerInputComponent(UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("MoveForward", this, &AFirstPersonShooterCharacter::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AFirstPersonShooterCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	InputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	InputComponent->BindAxis("TurnRate", this, &AFirstPersonShooterCharacter::TurnAtRate);
	InputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	InputComponent->BindAxis("LookUpRate", this, &AFirstPersonShooterCharacter::LookUpAtRate);
}
...
bool AFirstPersonShooterCharacter::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AFirstPersonShooterCharacter::BeginTouch);
		InputComponent->BindTouch(EInputEvent::IE_Released, this, &AFirstPersonShooterCharacter::EndTouch);
